...
def write_infoc():
    ...
    info_c.append("void print_base(int tbit){")
    info_c.append("  switch(tbit){")
    info_c.append("  case _VOID:")    
    info_c.append("    printf(\"0x%lx\", (long int)data);")    
    info_c.append("break;")
    info_c.append("  case _ADDR_T:")    
    info_c.append("    printf(\"0x%lx\", (long int)data);")    
    info_c.append("    break;")
    info_c.append("  case _LONG_UNSIGNED_INT:")    
    info_c.append("    printf(\"%lu\", (long unsigned int)data);")
    info_c.append("    break;")
    info_c.append("  case _UNSIGNED_CHAR:")    
    info_c.append("    printf(\"%hhu\", (unsigned char)data);")    
    info_c.append("    break;")
    info_c.append("  case _SHORT_UNSIGNED_INT:")    
    info_c.append("    printf(\"%hu\", (short unsigned int)data);")    
    info_c.append("    break;")
    info_c.append("  case _UNSIGNED_INT:")    
    info_c.append("    printf(\"%u\", (unsigned int)data);")    
    info_c.append("    break;")
    info_c.append("  case _SIGNED_CHAR:")
    info_c.append("    printf(\"%hhd\", (signed char)data);")
    info_c.append("    break;")
    info_c.append("  case _SHORT_INT:")    
    info_c.append("    printf(\"%d\", (short int)data);")    
    info_c.append("    break;")
    info_c.append("  case _INT:")    
    info_c.append("    printf(\"%d\", (int)data);")    
    info_c.append("    break;")
    info_c.append("  case _LONG_INT:")    
    info_c.append("    printf(\"%ld\", (long int)data);")
    info_c.append("    break;")
    info_c.append("  case _FLOAT:")    
    info_c.append("    printf(\"%f\", (float)data);")    
    info_c.append("    break;")
    info_c.append("  case _DOUBLE:")    
    info_c.append("    printf(\"%lf\", (double)data);")
    info_c.append("    break;")
    info_c.append("  case _CHAR:")
    info_c.append("    printf(\"%c\", (char)data);")
    info_c.append("    break;")
    info_c.append("  default:")
    info_c.append("    printf(\"[%s] not defined\", __func__);")    
...
def write_infoh():
    ...
    info_h.append("#define GVARS_SIZE " + str(len(gvarl_all)))
    info_h.append("")
